...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        print('spatial features ext', spatial_features.shape)

        print('color histogram features ext', hist_features.shape)

        print('hog features ext', hog_features.shape)
...
def find_cars(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            print(spatial_features[0:5])

            print('color histogram features', hist_features.shape)
            print(hist_features[0:5])

            print('hog features', hog_features.shape)
            print(hog_features[0:5])
            ...
            test_features = X_scaler.transform(stack).reshape(1, -1)
...
# print('image list', images[0:10], images[-10:])
...
print('car features', len(car_features), len(car_features[0]))
